...
beautiful.init(gears.filesystem.get_configuration_dir() .. "marftheme.lua")
...
mytextclock = awful.widget.textclock('%a %d-%m-%Y  <span color="#ff0000" font="DSEG7 Classic Mini 11">%H:%M:%S</span> ', 1)
...
-- autoStartup
awful.spawn.once("polkit-dumb-agent")
awful.spawn.once("nm-applet")
awful.spawn.with_shell("~/.config/awesome/autorun.sh")
awful.spawn.once("blueman-applet")
awful.spawn.once("xclip")
awful.spawn.once("flameshot")
--awful.spawn("spotifyd")
--Custom Stuff
--To prvent discord fucking up with their massive icons flooding my screen
